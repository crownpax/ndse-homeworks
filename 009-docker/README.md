...
## Задание 1 - Docker CLI (ответы находятся в task1.md)
...
## Задание 2 - Environment Variables (ответы находятся в task2.md)
...
## Задание 3 - Volumes (ответы находятся в task3.md)
